...
echo "*****" >> $CAMERA_PATH/cv.log
echo "Environment is:" $VIRTUAL_ENV >> $CAMERA_PATH/cv.log
sleep 20

# Start the program
pwd
cd /home/odroid/projects/AutomatedHome/camera
$CAMERA_ENV/bin/python3 $CAMERA_PATH/camera_view.py
#$CAMERA_ENV/bin/python3 $CAMERA_PATH/camera_view.py >> $CAMERA_PATH/cv.log 2>&1
